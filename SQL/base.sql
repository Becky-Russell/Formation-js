...
SELECT date_embauche AS 'Recrutement 2010' FROM employes WHERE date_embauche = 2010;

-- 11- Afficher le salaire moyen des employés ayant été recrutées sur la période de 2005 à 2007 inclu
SELECT AVG(salaire) FROM employes WHERE date_embauche BETWEEN '2005-01-01' AND '2007-01-01';
...
SELECT * FROM employes WHERE service != 'production' AND service != 'secreteriat';
...
-- 17- Afficher le prenom deu commercial ayant le salaire le plus élevé
